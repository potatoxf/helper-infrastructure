...
public class InternalComparator<T, E> extends AbstractComparator<T> {
  private final FactoryThrow<T, E, RuntimeException> factoryThrow;

  private final AbstractComparator<E> elementComparator;

  public InternalComparator(FactoryThrow<T, E, RuntimeException> factoryThrow) {
    this(true, factoryThrow);
  }

  public InternalComparator(
      boolean isNullElementLast, FactoryThrow<T, E, RuntimeException> factoryThrow) {
  ...
  protected int doCompareAfter(T o1, T o2) {
    return elementComparator.compare(factoryThrow.handle(o1), factoryThrow.handle(o2));
  }
}
