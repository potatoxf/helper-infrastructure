 ...
 * @author potatoxf
 * @date 2022/01/30
 * @see HelperOnClass#filterClass(Iterable, ClassFilter)
 */
@Documented
...
public @interface ClassFilter {
   ...
   * 筛选注解
   *
   * <p>条件：只要有一个类符合{@code ClassHelper.lookupAnnotationOnClass(clz, aClass) != null}
   *
   * @return {@code Class<?>[]}
   * @see HelperOnClass#lookupAnnotationOnClass(Class, Class)
   */
   ...
   * 筛选注解
   *
   * <p>条件：所有类都符合{@code ClassHelper.lookupAnnotationOnClass(clz, aClass) == null}
   *
   * @return {@code Class<?>[]}
   * @see HelperOnClass#lookupAnnotationOnClass(Class, Class)
   */
