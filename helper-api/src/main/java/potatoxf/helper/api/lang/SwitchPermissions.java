...
import potatoxf.helper.api.HelperOnString;
import potatoxf.helper.api.iterate.ArrayIteratorOnInt;
...
public class SwitchPermissions {
  ...
  public SwitchPermissions(int maxLength, int radix) {
    ...
    this.radix = radix;
    String maxSizeStr =
        HelperOnString.repeat(
                CharSequenceAppendable.ofStringBuilder(maxLength),
  ...
  public String settingPermissions(
    ...
    return compute(
        range, permissionValue, BigInteger::setBit, () -> new ArrayIteratorOnInt(permissions));
  }
  ...
  public String cancelPermissions(
      @Nullable String range, @Nonnull String permissionValue, @Nonnull int... permissions) {
    return compute(
        range, permissionValue, BigInteger::clearBit, () -> new ArrayIteratorOnInt(permissions));
  }
  ...
  public boolean hasPermissions(@Nonnull String permissionValue, @Nonnull int... permissions) {
    return hasPermissions(permissionValue, () -> new ArrayIteratorOnInt(permissions));
  }
