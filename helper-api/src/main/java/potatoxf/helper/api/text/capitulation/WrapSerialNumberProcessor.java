 ...
 * @date 2021/06/19
 */
public class WrapSerialNumberProcessor implements SerialNumberProcessor {
  ...
  public WrapSerialNumberProcessor(String prefix, String suffix) {

    this(prefix, suffix, null);
  }

  public WrapSerialNumberProcessor(
