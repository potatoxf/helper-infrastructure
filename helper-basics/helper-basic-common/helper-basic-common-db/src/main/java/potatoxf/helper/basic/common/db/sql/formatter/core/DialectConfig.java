...
public class DialectConfig {
  ...
  DialectConfig(
    ...
    this.lineCommentTypes = Tools.safeValue(lineCommentTypes);
    this.reservedTopLevelWords = Tools.safeValue(reservedTopLevelWords);
    this.reservedTopLevelWordsNoIndent = Tools.safeValue(reservedTopLevelWordsNoIndent);
    this.reservedNewlineWords = Tools.safeValue(reservedNewlineWords);
    this.reservedWords = Tools.safeValue(reservedWords);
    this.specialWordChars = Tools.safeValue(specialWordChars);
    this.stringTypes = Tools.safeValue(stringTypes);
    this.openParens = Tools.safeValue(openParens);
    this.closeParens = Tools.safeValue(closeParens);
    this.indexedPlaceholderTypes = Tools.safeValue(indexedPlaceholderTypes);
    this.namedPlaceholderTypes = Tools.safeValue(namedPlaceholderTypes);
    this.operators = Tools.safeValue(operators);
  }
